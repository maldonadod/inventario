...
class FireBaseProductosDeOrdenDeCompraRepositorio {
  observar(observador) {
    firebase
      .database()
      .ref("productos")
      .on("value", (snapshot) => {
        const productosDiccionario = snapshot.val();
        const listaDeNombreDeProductos = Object.values(productosDiccionario);
        observador.ejecutar(listaDeNombreDeProductos);
      })
  }
...
export default FireBaseProductosDeOrdenDeCompraRepositorio;